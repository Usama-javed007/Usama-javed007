...
🏢 COMMTEL                                           Jun 2024 – Present
   Sr. Penetration Tester · Full-time · Hybrid            (2+ years)
─────────────────────────────────────────────────────────────────────
  Lead security assessments across Web, Mobile, Desktop, Network,
  Cloud & Active Directory. Manage the security testing team and
  oversee SDLC security practices. Bridge between engineering and
  security — making sure vulnerabilities are found early and fixed.
```

```
🏢 DUNICOT                                         Jan 2022 – Jun 2024
   Penetration Tester · Hybrid                          (2.5 years)
─────────────────────────────────────────────────────────────────────
  Conducted Web Application & Network security testing aligned with
  OWASP standards. Identified critical vulnerabilities and provided
  detailed remediation guidance to development and ops teams.
```

```
🐛 BUG BOUNTY HUNTER                               Jun 2021 – Apr 2022
...
[![Intigriti](https://img.shields.io/badge/Intigriti-1E1E1E?style=for-the-badge&logoColor=white)](https://intigriti.com)
